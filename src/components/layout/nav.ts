...
export type NavGroup = { label: string; icon: LucideIcon; adminOnly?: boolean; children: NavItem[] }
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    icon: BookOpen,
    children: [
      { href: '/classes', label: '정규반 관리', icon: Book },
      { href: '/materials', label: '자료실', icon: FolderOpen },
      { href: '/calendar', label: '정규 캘린더', icon: Calendar },
      { href: '/timetable', label: '주간 시간표', icon: Clock },
    ],
  },
  {
    label: '클리닉반 관리',
    icon: Stethoscope,
    children: [
      { href: '/clinic', label: '클리닉반 관리', icon: Stethoscope },
      { href: '/clinic/materials', label: '클리닉 자료실', icon: FolderOpen },
      { href: '/clinic/calendar', label: '클리닉 캘린더', icon: Calendar },
    ],
  },
  {
    label: '원장 통합 관리',
    ...
    adminOnly: true,
    children: [
      { href: '/admin/students', label: '학생 통합 관리', icon: GraduationCap },
      { href: '/admin/classes', label: '정규반 관리', icon: Book },
      { href: '/admin/clinics', label: '클리닉반 관리', icon: Stethoscope },
      { href: '/admin/teachers', label: '강사 관리', icon: Users },
